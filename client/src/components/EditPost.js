    ...
    return ( 
        <div className="w-full h-full my-6">
             <form  className='w-3/5 max-md:w-full h-1/2 flex flex-col gap-y-5 mx-auto shadow-lg '>
                <h1 className='text-center text-2xl font-semibold my-2 font-sans '>Edit Post</h1>
                ...
                <div className="relative flex gap-x-4 h-10 w-10/12 mx-auto">
                    <button onClick={submitHandler}
                        className='w-fit h-fit  bg-zinc-700 px-4  py-1 text-white rounded hover:bg-zinc-900
                    ...
                    <button
                        ...
                        className="bg-red-700 w-fit h-fit text-white p-1 px-4 rounded hover:bg-red-900
